...
class Main extends CI_Controller {
	public function email(){
		echo kirim_email('Coba Kirimkan Email','Ini adalah isi Pesan yang dikirim...','robby.prihandaya@gmail.com');
		echo "E-mail Terkirim,..";
	}

	public function wa(){
		$this->model_app->wa(format_telpon('081267771344'),'Coba Kirimkan WA...');
		echo "WA Terkirim,..";
	}
	...
	function proses(){
		...
		if ($_POST['produk']!=''){
			...
			$urla = 'https://tripay.id/api/v2/pembelian/produk/';
			$headera = array(
			'Accept: application/json',
			'Authorization: Bearer '.$maps[0], // Ganti [apikey] dengan API KEY Anda
			);
