            ...
            <div class="ps-layout--shop">
                ...
                <div class="ps-layout__right">
                    ...
                    <?php 
                        ...
                        <select class='form-control list_provinsi' name='provinsi' style='background:#fff'>";
                        ...
                        <select class='form-control list_kotakab' name='kota' style='background:#fff'>";
                        ...
                        <select class='form-control list_kecamatan' name='kecamatan' style='background:#fff'>";
