                                ...
                                <div class='ps-product--cart'>
                                    ...
                                    <b>Qty.</b> $row[jumlah] x ".rupiah($row['harga_jual']-$row['diskon'])." = ";
                                      ...
                                      echo "<br>";
                                        ...
                                        if ($cekk['jenis_produk']=='Digital' AND $total['proses']=='4' AND $this->session->id_konsumen==$rows['id_konsumen']){
                                            if ($cekk['produk_file'] != ''){ 
                            ...
                            <ul class="ps-block__product">
                                <?php
                                  ...
                                  foreach ($penjual->result_array() as $pen) {
                                    ...
                                    if ($kupon['diskon']>0){
                                        echo "<b>Belanja</b> : <del style='color:#8a8a8a'>Rp ".rupiah($bel['total'])."</del> Rp ".rupiah($bel['total']-$kupon['diskon']);
                                    }else{
                                        echo "<b>Belanja</b> : Rp ".rupiah($bel['total']-$kupon['diskon']);
                                    }

                                    if ($cekk['jenis_produk']=='Fisik'){
                                        echo "<br><b>Ongkir</b> : Rp ".rupiah($pen['ongkir'])." <small style='color:blue'>($ber[berat] Gram)</small><br>";
                                        ...
                                        $dikirim_dari = 'Alamat Penjual';
                                    }

                                    echo "<br><b>$dikirim_dari</b> : $pen[alamat_lengkap], ".kecamatan($pen['kecamatan_id'],$pen['kota_id'])."<br>";
                                    if ($pen['kode_kurir']!='0'){
                                        if ($total['proses']>=3){
                                            if ($pen['kode_kurir']!='1'){  
