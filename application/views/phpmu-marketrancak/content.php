<div id="homepage-1">
                ...
                <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
                    <?php 
                        ...
                        foreach ($slide1->result_array() as $row) {
                            ...
                            $judul = $ex[1];
                            echo "<div class='ps-banner'><a target='_BLANK' title='$judul' href='".$ex[0]."'><img  style='width:100%' class='preview' loading='lazy' src='$foto_slide' alt='$row[gambar]'></a></div>"; 
                            $no++;
                        }
                    ?>
                </div>
    ...
    <div class="ps-top-categories d-block d-sm-none" style='margin-top:20px'>
        ...
        </div><center><a style='margin-top:20px' class="ps-toggle--sidebar btn-custom" href="#navigation-mobile"><i class="icon-list4"></i><span> Tampilkan Semua Kategori</span></a></center><br>
