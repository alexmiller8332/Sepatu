...
function notif_penjual($kode_transaksi){
    ...
    foreach ($penjual_notifx->result_array() as $penx) {
        ...
        $isi_pesan_penjual = "*$iden[pengirim_email]* - Haloo *$penx[nama_reseller]*, ada orderan masuk di toko anda dengan No Invoice #$kode_transaksi, total belanja *Rp ".rupiah($belx['total'])."*, yuk cek di ".base_url()."konfirmasi/tracking/$kode_transaksi";
        ...
        $message_notif = "<html><body><b>$iden[pengirim_email]</b> - Haloo <b>$penx[nama_reseller]</b>, ada orderan masuk di toko anda dengan No Invoice #$kode_transaksi, total belanja *Rp ".rupiah($belx['total'])."*, yuk cek di ".base_url()."konfirmasi/tracking/$kode_transaksi</body></html>";
...
Silahkan menjemput Kiriman ke alamat Toko/Pelapak di :
...
anda juga bisa cek status order di ".base_url()."konfirmasi/tracking/$toko[kode_transaksi]";
        ...
        $message_notif = "<html><body><b>$iden[pengirim_email]</b> - Haloo <b>$row[nama_lengkap]</b> Kurir $row[jenis_kendaraan]<br> 
                            ...
                            Silahkan menjemput Kiriman ke Toko/Pelapak di :<br>
